...
.atla{position:absolute; left:-9999px; top:0; background:#000; color:#fff; padding:10px 16px; z-index:200}
...
.ust{
  ...
  background:#ebebeb; border-bottom:3px solid var(--cizgi);
}
.ust-ic{
...
@media (max-width:880px){
  ...
  .menu a{padding:15px 0; font-size:13px; border-bottom:1px solid #d6d6d6}
  .menu a::before{display:none}
  .menu a.etkin{font-weight:800}
}

/* ── Kahraman ────────────────────────────────────────────── */
.hero{position:relative; background:#d9dadb; overflow:hidden}
.hero-gorsel img{
...
.mono-harf i{
  ...
  color:#fff; text-shadow:0 2px 40px rgba(0,0,0,.14);
...
.mono-cizgi{
  display:block; width:clamp(74px,13vw,150px); height:3px; background:#fff; margin-top:.22em;
...
.giris .metin p{font-size:17px; color:#2a2a2a}
...
.dg:hover{background:var(--cizgi); color:#fff; transform:translateY(-2px)}
.dg-koyu{background:var(--cizgi); color:#fff}
...
.proje-kart p{font-size:15px; color:#3a3a3a; margin-bottom:.5em}
...
.hizmet-akis .hizmet{background:var(--kart); padding:28px 26px; margin:0}
...
.hizmet p{font-size:15.5px; color:#333}

.hizmetler-bolum.tam .hizmet{
  display:grid; gap:clamp(24px,4vw,54px); align-items:center;
  padding:clamp(28px,4vw,44px) 0; border-top:1px solid #d3d3d3; margin:0;
}
...
.hizmet-gorsel img{width:100%; border:1px solid #ddd}
...
.neden-kart p{font-size:15px; color:#3a3a3a; margin:0}

/* ── Çağrı şeridi ────────────────────────────────────────── */
.cta{background:var(--bar); color:#fff}
.cta .bolum-bas{color:#fff}
.cta-metin{text-align:center; max-width:720px; margin:0 auto; color:#d7d7d7}
.cta .dg{border-color:#fff; color:#fff}
.cta .dg:hover{background:#fff; color:var(--bar)}
.cta .dg-koyu{background:#fff; color:var(--bar)}
.cta .dg-koyu:hover{background:transparent; color:#fff}

/* ── İletişim ────────────────────────────────────────────── */
.iletisim{background:var(--zemin-ac)}
.ilt{margin:0}
.ilt-satir{display:grid; gap:4px 20px; padding:18px 0; border-top:1px solid #d3d3d3}
...
.alt-logo{font-size:clamp(22px,3vw,30px); font-weight:800; letter-spacing:-.03em; margin:0}
.alt-kisi{font-weight:600; margin:0 0 14px}
.alt-sat{margin:0 0 6px; color:#333}
.alt-sat a{text-decoration:none; border-bottom:1px solid #bbb}
...
.yukari{
  ...
  background:rgba(140,140,140,.85); color:#fff; text-decoration:none;
...
.dock-dg{
  ...
  background:rgba(255,255,255,.78); color:var(--murekkep);
...
.dock-dg:hover{transform:translateY(-3px); box-shadow:0 16px 36px rgba(0,0,0,.22); background:#fff}
.dock-ikon{
...
.nokta{
  width:9px; height:9px; border-radius:50%; background:var(--yesil); flex:0 0 9px;
  box-shadow:0 0 0 0 rgba(31,157,85,.5); animation:canli 2s infinite;
}
...
.bildirim p{margin:0 0 12px; font-size:14px; color:#3a3a3a; line-height:1.5}
...
.bildirim-kapat{
  ...
  background:none; color:#777; font-size:19px; line-height:1; cursor:pointer;
}
.bildirim-kapat:hover{background:#f0f0f0; color:#111}
...
/* ── Görsel yer tutucu ───────────────────────────────────── */
.gorsel-yok{
  display:grid; place-items:center; aspect-ratio:4/3; background:#dcdcdc;
  color:#7b7b7b; font-size:12px; font-weight:700; letter-spacing:.16em; text-align:center;
}
